...
* **Did the problem start happening recently** (e.g. after updating to a new version of splash-kit) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of splash-kit ?** What's the most recent version in which the problem doesn't happen? You can download older versions of splash-kit from [the releases page](https://github.com/digipolitan/splash-kit/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of splash-kit are you using?
...
#### Template For Submitting Bug Reports
    ...
    **splash-kit version:** [Enter splash-kit version here]
    ...
    * Problem started happening recently, didn't happen in an older version of splash-kit: [Yes/No]
